                        ...
                        <div className="contact-info-card">
                            ...
                            <div className="row mb-2">
                                ...
                                <div className="col-10 ">
                                    <h6 className="d-inline">Phone : <br /> <span className="text-muted">0367233265</span></h6>
                                </div>
                            </div>
                            <div className="row mb-2">
                                <div className="col-1 pt-1 mr-1">
                                ...
                                <div className="col-10">
                                    <h6 className="d-inline">Address :<br /> <span className="text-muted">Ngõ 35,Lê Đức Thọ,Nam Từ Liêm,hà Nội</span></h6>
                                </div>
                            </div>
                            <div className="row mb-2">
                                <div className="col-1 pt-1 mr-1">
